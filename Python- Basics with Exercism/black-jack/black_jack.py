...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    value_of_both = value_of_card(card_one) + value_of_card(card_two)

    if card_one =='A' or card_two == 'A':
        return 1
    elif value_of_both <= 10:
        return 11
    else:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    value_of_both = value_of_card2(card_one) + value_of_card2(card_two)
